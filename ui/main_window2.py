...
class MainWindow(QMainWindow):
    ...
    def _setup_ui(self):
        ...
        self.layout_palavras.addWidget(QComboBox(),2,1,1,2)
        ...
        self.layout_palavras.addWidget(QLineEdit(),5,1)
        self.layout_palavras.addWidget(QLineEdit(),5,2)
        self.layout_palavras.addWidget(self.lbl_ex_presente,6,0)
        self.layout_palavras.addWidget(self.txt_ex_pt_presente,6,1)
        self.layout_palavras.addWidget(self.txt_ex_de_presente,6,2)
        self.layout_palavras.addWidget(self.lbl_ex_passado,7,0)
        self.layout_palavras.addWidget(self.txt_ex_pt_passado,7,1)
        self.layout_palavras.addWidget(self.txt_ex_de_passado,7,2)
        self.layout_palavras.addWidget(self.lbl_ex_futuro,8,0)
        self.layout_palavras.addWidget(self.txt_ex_pt_futuro,8,1)
        self.layout_palavras.addWidget(self.txt_ex_de_futuro,8,2)
        self.layout_palavras.addWidget(self.lbl_observacoes,9,0)
